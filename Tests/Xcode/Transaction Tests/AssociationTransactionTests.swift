...
class AssociationTransactionTests : XCTestCase {
	...
	//------------------------------------------------------------------------------------------------------------------
	func testDetailGetValue() throws {
		// Setup
		let	associationName = "\(Parent.documentType)To\(Child.documentType.capitalizingFirstLetter)"
		...
		var	(getValueInfo1, getValueError1) =
					config.httpEndpointClient.associationGetValues(documentStorageID: config.documentStorageID,
							name: associationName, action: .detail, fromDocumentIDs: [parent.id], cacheName: cacheName,
		...
		XCTAssertNotNil(getValueInfo1!.info, "get value (1) did not receive info")
		let cachedValues1 = getValueInfo1?.info as? [[String : Any]]
		XCTAssertNotNil(cachedValues1, "get value (1) did not receive cached values")
		XCTAssertEqual(cachedValues1!.count, 2, "get value(1) did not receive correct count")
		XCTAssertEqual(cachedValues1![0]["fromID"] as? String, parentInfos![0]["documentID"] as? String, "get value(1) mismatching value")
		XCTAssertEqual(cachedValues1![0]["toID"] as? String, childInfos1![0]["documentID"] as? String, "get value(1) mismatching value")
		XCTAssertEqual(cachedValues1![0]["size"] as? Int64, 123, "get value(1) mismatching value")
		XCTAssertEqual(cachedValues1![1]["fromID"] as? String, parentInfos![0]["documentID"] as? String, "get value(1) mismatching value")
		XCTAssertEqual(cachedValues1![1]["toID"] as? String, childInfos1![1]["documentID"] as? String, "get value(1) mismatching value")
		XCTAssertEqual(cachedValues1![1]["size"] as? Int64, 456, "get value(1) mismatching value")
		...
		XCTAssertNotNil(getValueInfo2!.info, "get value (2) did not receive info")
		let cachedValues2 = getValueInfo2?.info as? [[String : Any]]
		XCTAssertNotNil(cachedValues2, "get value (2) did not receive cached values")
		XCTAssertEqual(cachedValues2!.count, 3, "get value(1) did not receive correct count")
		XCTAssertEqual(cachedValues2![0]["fromID"] as? String, parentInfos![0]["documentID"] as? String, "get value(1) mismatching value")
		XCTAssertEqual(cachedValues2![0]["toID"] as? String, childInfos1![0]["documentID"] as? String, "get value(1) mismatching value")
		XCTAssertEqual(cachedValues2![0]["size"] as? Int64, 123, "get value(1) mismatching value")
		XCTAssertEqual(cachedValues2![1]["fromID"] as? String, parentInfos![0]["documentID"] as? String, "get value(1) mismatching value")
		XCTAssertEqual(cachedValues2![1]["toID"] as? String, childInfos1![1]["documentID"] as? String, "get value(1) mismatching value")
		XCTAssertEqual(cachedValues2![1]["size"] as? Int64, 456, "get value(1) mismatching value")
		XCTAssertEqual(cachedValues2![2]["fromID"] as? String, parentInfos![0]["documentID"] as? String, "get value(1) mismatching value")
		XCTAssertEqual(cachedValues2![2]["toID"] as? String, childInfos2![0]["documentID"] as? String, "get value(1) mismatching value")
		XCTAssertEqual(cachedValues2![2]["size"] as? Int64, 789, "get value(1) mismatching value")
		XCTAssertNil(getValueError2, "get value (2) received error: \(getValueError2!)")
	}

	//------------------------------------------------------------------------------------------------------------------
	func testSumGetValue() throws {
		// Setup
		let	associationName = "\(Parent.documentType)To\(Child.documentType.capitalizingFirstLetter)"
		let	cacheName = UUID().uuidString
		let	config = Config.current
		...
		guard getValueInfo1 != nil else { return }
		XCTAssertNotNil(getValueInfo1!.info, "get value (1) did not receive info")
		let cachedValues1 = getValueInfo1?.info as? [String : Int64]
		XCTAssertNotNil(cachedValues1, "get value (1) did not receive cached values")
		XCTAssertEqual(cachedValues1!["count"], 2, "get value(1) did not receive correct count")
		XCTAssertEqual(cachedValues1!["size"], 123 + 456, "get value (1) did not receive correct value")
		XCTAssertNil(getValueError1, "get value (1) received error: \(getValueError1!)")
		...
		guard getValueInfo2!.isUpToDate else { return }
		XCTAssertNotNil(getValueInfo2!.info, "get value (2) did not receive info")
		let cachedValues2 = getValueInfo2?.info as? [String : Int64]
		XCTAssertNotNil(cachedValues2, "get value (2) did not receive cached values")
		XCTAssertEqual(cachedValues2!["count"], 3, "get value(2) did not receive correct count")
		XCTAssertEqual(cachedValues2!["size"], 123 + 456 + 789,
